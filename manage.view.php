...
<head>
  ...
  <link type="text/css" rel="stylesheet" href="map/leaflet/MarkerCluster.css"><!--<link type="text/css" rel="stylesheet" href="map/leaflet/MarkerCluster.Default.css"/>-->
  ...
  <script type="text/javascript" src="js/jquery.min.js?v=%3C?php%20echo%20$last_ver['jquery.min.js']%20?%3E"></script>
  <script type="text/javascript" src="js/jquery-dateFormat.min.js?%3E"></script>
  <script type="text/javascript" src="js/common.js?v=%3C?php%20echo%20$last_ver['common.js']%20?%3E"></script>
  <script type="text/javascript" src="js/%3C?php%20echo%20$last_name['devicelist.js']%20?%3E?v=%3C?php%20echo%20$last_ver['devicelist.js']%20?%3E"></script>
  <script type="text/javascript" src="js/manage.js?v=%3C?php%20echo%20$last_ver['manage.js']%20?%3E"></script>
  ...
  <script type="text/javascript" src="js/timepicker.js?v=%3C?php%20echo%20$last_ver['timepicker.js']%20?%3E"></script>
  ...
  <script type="text/javascript" src="map/leaflet/proj4leaflet.js"></script><!--<script type="text/javascript" src="map/leaflet/leaflet.rotatedMarker.js"></script>-->
  ...
  <script type="text/javascript" src="map/%3C?php%20echo%20$last_name['map.operat.js']%20?%3E?v=%3C?php%20echo%20$last_ver['map.operat.js']%20?%3E"></script>
  <script type="text/javascript" src="map/%3C?php%20echo%20$last_name['map.leaflet.js']%20?%3E?v=%3C?php%20echo%20$last_ver['map.leaflet.js']%20?%3E"></script>
  <script type='text/javascript' src="js/sortable.min.js"></script><!-- Leaflet.draw -->
  ...
  <script type="text/javascript" src="map/leaflet/draw/edit/handler/Edit.Rectangle.js"></script><!-- Leaflet.draw -->
...
<body onload="oninit();">
  ...
  <div id="tab_mgraccount" class="tab_content">
    <div class="search_bar">
      <ul class="flat">
        <li><select id="mgraccount_item" class="iselect">
          <option value='1' selected='selected'>
            <?php echo $TEXT['info-username'] ?>
          </option>
          <option value='2'>
            <?php echo $TEXT['login-account'] ?>
          </option>
          <option value='3'>
            <?php echo $TEXT['info-userphone'] ?>
          </option>
        </select> <input id="mgraccount_cond" type="text" class="itext enablebox" maxlength="30"></li>
        ...
        <li><input id="usr_tips" type="text" class="ilabel" readonly="readonly"></li>
      </ul>
    </div>
    <div class="user_area">
      ...
      <div style="background: #ccc;">
        <table>
          ...
          <tr>
            ...
            <td><span><a style='padding-left: 20px;' title='<?php echo $TEXT['>' class="operate_search" id="group_filter" href="#"&gt;</a></span></td>
            <td><span><a style='padding-left: 20px;' title='<?php echo $TEXT['>' class="operate_add" id="group_addnew" href="#"&gt;</a></span></td>
            <td><span><a style='padding-left: 20px;' title='<?php echo $TEXT['>' class="operate_edit" id="group_edit_btn" href="#"&gt;</a></span></td>
            <td><span><a style='padding-left: 20px;' title='<?php echo $TEXT['>' class="operate_delete" id="group_delete" href="#"&gt;</a></span></td>
          </tr>
        </table>
      </div>
    ...
    <div id="usr_edit" class="edit_area">
      <ul class="list">
        <li>
          <fieldset>
            <legend>1.<?php echo $TEXT['info-accountinfo'] ?></legend> <input id="usrid" type="hidden"> <label id="luname" for="uname">*<?php echo $TEXT['info-username'] ?></label> <input id="uname" type="text" class="itext disablebox" name="uname" maxlength="50"> <label for="login">*<?php echo $TEXT['login-account'] ?></label> <input id="login" type="text" class="itext disablebox" name="login" maxlength="50">
            <div id="usr_upass">
              <label for="upass">*<?php echo $TEXT['login-password'] ?></label> <input id="upass" type="password" class="itext disablebox" name="upass" maxlength="50">
            </div><label for="email"><?php echo $TEXT['info-email'] ?></label> <input id="email" type="text" class="itext disablebox" name="email" maxlength="100"> <label id="lvalid" for="valid"><?php echo $TEXT['info-available'] ?></label> <input id="valid" type="checkbox" class="icheck disablebox" name="valid"> <label for="uphone"><?php echo $TEXT['info-userphone'] ?></label> <input id="uphone" type="text" class="itext disablebox" name="upass" maxlength="16"> <label id="lolimit" for="olimit">*<?php echo $TEXT['info-limitcar'] ?></label> <input id="olimit" type="text" class="itext disablebox" name="olimit" maxlength="16">
          </fieldset>
        </li>
        <li class='emailopt'>
          <fieldset>
            <legend>2.<?php echo $TEXT['info-emailreportinfo'] ?></legend> <label for="rmail"><?php echo $TEXT['info-emailreport'] ?></label> <input id="rmail" type="checkbox" class="icheck disablebox" name="rmail"> <label for="rtime"><?php echo $TEXT['info-emailoffset'] ?></label> <input id="rtime" type="text" class="itext disablebox" name="rtime" maxlength="5"> <label for="rusagedy" style="margin-right: 10px;"><?php echo $TEXT['info-select-report'] ?></label> <select id="selectreport" name="selectreport" class="iselect" multiple size="0">
              <option value="0_1_1">
                <?php echo $TEXT['info-usagedailyreport'] ?>
              </option>
              <option value="1_0_1">
                <?php echo $TEXT['info-usageweeklyreport'] ?>
              </option>
              <option value="2_0_1">
                <?php echo $TEXT['info-usagemonthlyreport'] ?>
              </option>
              <option value="0_0_2">
                <?php echo $TEXT['info-speeddailyreport'] ?>
              </option>
              <option value="0_0_3">
                <?php echo $TEXT['info-traveldailyreport'] ?>
              </option>
              <option value="0_1_4">
                <?php echo $TEXT['info-alarmdailyreport'] ?>
              </option><!--<option value="0_1_10"><?php echo $TEXT['info-geodailyreport'] ?></option>-->
              <option value="0_0_12">
                <?php echo $TEXT['info-refuelreport'] ?>
              </option>
              <option value="0_0_13">
                <?php echo $TEXT['info-stealfuelreport'] ?>
              </option>
              <option value="0_1_14">
                <?php echo $TEXT['info-maxspeeddailyreport'] ?>
              </option>
              <option value="0_1_15">
                <?php echo $TEXT['info-expirationreport'] ?>
              </option>
            </select>
          </fieldset>
        </li>
        <li id="usr_operat">
          <fieldset>
            ...
            <ul class="flat">
              <li><input id="usr_save" type="button" class="small button" disabled value="<?php echo $TEXT['button-save'] ?>"></li>
              <li><input id="usr_update" type="button" class="small button" disabled value="<?php echo $TEXT['button-update'] ?>"></li>
              <li><input id="usr_cancel" type="button" class="small button" disabled value="<?php echo $TEXT['button-cancel'] ?>"></li>
            </ul>
          </fieldset>
        </li>
      </ul>
    </div>
  </div><!--manage user access-->
  <div id="tab_useraccess" class="tab_content">
    <div class="search_bar">
      <ul class="flat">
        <li><select id="useraccess_item" class="iselect">
          <option value='1' selected='selected'>
            <?php echo $TEXT['info-username'] ?>
          </option>
          <option value='2'>
        ...
        </select> <input id="useraccess_cond" type="text" class="itext enablebox" maxlength="30"></li>
    ...
    <div id="purview_edit" class="purview_area">
      <ul class="list">
        <li id="p_3000">
          <fieldset>
            <legend>1.<?php echo $TEXT['manage-mgraccount'] ?></legend> <label id="account_add_l" for="account_add"><?php echo $TEXT['purview-add'] ?></label> <input id="account_add" type="checkbox" class="icheck disablebox" name="account_add"> <label id="account_eidt_l" for="account_eidt"><?php echo $TEXT['purview-edit'] ?></label> <input id="account_eidt" type="checkbox" class="icheck disablebox" name="account_eidt"> <label id="account_delete_l" for="account_delete"><?php echo $TEXT['purview-delete'] ?></label> <input id="account_delete" type="checkbox" class="icheck disablebox" name="account_delete"> <label id="account_email_l" for="account_email"><?php echo $TEXT['purview-email'] ?></label> <input id="account_email" type="checkbox" class="icheck disablebox" name="account_email"> <label id="group_edit_l" for="group_edit"><?php echo $TEXT['purview-group'] ?></label> <input id="group_edit" type="checkbox" class="icheck disablebox" name="group_edit"> <label id="access_edit_l" for="access_edit"><?php echo $TEXT['purview-access'] ?></label> <input id="access_edit" type="checkbox" class="icheck disablebox" name="access_edit"> <label id="cmd_edit_l" for="cmd_edit"><?php echo $TEXT['cmd-access'] ?></label> <input id="cmd_edit" type="checkbox" class="icheck disablebox" name="cmd_edit">
          </fieldset>
        </li>
        <li id="p_2100">
          <fieldset>
            <legend>2.<?php echo $TEXT['manage-mgrcustomer'] ?></legend> <label id="cust_add_l" for="cust_add"><?php echo $TEXT['purview-add'] ?></label> <input id="cust_add" type="checkbox" class="icheck disablebox" name="cust_add"> <label id="cust_edit_l" for="cust_edit"><?php echo $TEXT['purview-edit'] ?></label> <input id="cust_edit" type="checkbox" class="icheck disablebox" name="cust_edit"> <label id="cust_delete_l" for="cust_delete"><?php echo $TEXT['purview-delete'] ?></label> <input id="cust_delete" type="checkbox" class="icheck disablebox" name="cust_delete">
          </fieldset>
        </li>
        <li id="p_1000">
          <fieldset>
            <legend>3.<?php echo $TEXT['manage-mgrvehicle'] ?></legend> <label id="asset_add_l" for="asset_add"><?php echo $TEXT['purview-add'] ?></label> <input id="asset_add" type="checkbox" class="icheck disablebox" name="asset_add"> <label id="asset_edit_l" for="asset_edit"><?php echo $TEXT['purview-edit'] ?></label> <input id="asset_edit" type="checkbox" class="icheck disablebox" name="asset_edit"> <label id="asset_delete_l" for="asset_delete"><?php echo $TEXT['purview-delete'] ?></label> <input id="asset_delete" type="checkbox" class="icheck disablebox" name="asset_delete"> <label id="asset_expired_l" for="asset_expired"><?php echo $TEXT['purview-expired'] ?></label> <input id="asset_expired" type="checkbox" class="icheck disablebox" name="asset_expired">
          </fieldset>
        </li>
        <li id="p_1300">
          <fieldset>
            <legend>4.<?php echo $TEXT['manage-mgrdriver'] ?></legend> <label id="driver_add_l" for="driver_add"><?php echo $TEXT['purview-add'] ?></label> <input id="driver_add" type="checkbox" class="icheck disablebox" name="driver_add"> <label id="driver_edit_l" for="driver_modify"><?php echo $TEXT['purview-edit'] ?></label> <input id="driver_modify" type="checkbox" class="icheck disablebox" name="driver_modify"> <label id="driver_delete_l" for="driver_delete"><?php echo $TEXT['purview-delete'] ?></label> <input id="driver_delete" type="checkbox" class="icheck disablebox" name="driver_delete">
          </fieldset>
        </li>
        <li id="p_1700">
          <fieldset>
            <legend>5.<?php echo $TEXT['manage-mgrplace'] ?></legend> <label id="place_add_l" for="place_add"><?php echo $TEXT['purview-add'] ?></label> <input id="place_add" type="checkbox" class="icheck disablebox" name="place_add"> <label id="place_edit_l" for="place_modify"><?php echo $TEXT['purview-edit'] ?></label> <input id="place_modify" type="checkbox" class="icheck disablebox" name="place_modify"> <label id="place_delete_l" for="place_delete"><?php echo $TEXT['purview-delete'] ?></label> <input id="place_delete" type="checkbox" class="icheck disablebox" name="place_delete">
          </fieldset>
        </li>
        <li id="p_1800">
          <fieldset>
            <legend>6.<?php echo $TEXT['manage-mgrtask'] ?></legend> <label id="task_add_l" for="task_add"><?php echo $TEXT['purview-add'] ?></label> <input id="task_add" type="checkbox" class="icheck disablebox" name="task_add"> <label id="task_edit_l" for="task_modify"><?php echo $TEXT['purview-edit'] ?></label> <input id="task_modify" type="checkbox" class="icheck disablebox" name="task_modify"> <label id="task_delete_l" for="task_delete"><?php echo $TEXT['purview-delete'] ?></label> <input id="task_delete" type="checkbox" class="icheck disablebox" name="task_delete">
          </fieldset>
        </li>
        <li id="p_1900">
          <fieldset>
            <legend>7.<?php echo $TEXT['manage-mgrexpense'] ?></legend> <label id="expense_add_l" for="expense_add"><?php echo $TEXT['purview-add'] ?></label> <input id="expense_add" type="checkbox" class="icheck disablebox" name="expense_add"> <label id="expense_edit_l" for="expense_modify"><?php echo $TEXT['purview-edit'] ?></label> <input id="expense_modify" type="checkbox" class="icheck disablebox" name="expense_modify"> <label id="expense_delete_l" for="expense_delete"><?php echo $TEXT['purview-delete'] ?></label> <input id="expense_delete" type="checkbox" class="icheck disablebox" name="expense_delete">
          </fieldset>
        </li>
        <li id="purview_operat">
          <fieldset>
            ...
            <ul class="flat">
              <li><input id="purview_update" type="button" class="small button" disabled value="<?php echo $TEXT['button-update'] ?>"></li>
              <li><input id="purview_cancel" type="button" class="small button" disabled value="<?php echo $TEXT['button-cancel'] ?>"></li>
            </ul>
          </fieldset>
        </li>
      </ul>
  ...
  <div id="tab_mgrcustomer" class="tab_content">
    <div class="search_bar">
      <ul class="flat">
        <li><select id="mgrcustomer_item" class="iselect">
          <option value='1' selected='selected'>
            <?php echo $TEXT['info-custname'] ?>
          </option>
          <option value='2'>
            <?php echo $TEXT['info-fullname'] ?>
          </option>
          <option value='3'>
            <?php echo $TEXT['info-contactphone'] ?>
          </option>
        </select> <input id="mgrcustomer_cond" type="text" class="itext enablebox" maxlength="30"></li>
        ...
        <li><input id="cust_tips" type="text" class="ilabel" readonly="readonly"></li>
      </ul>
    </div>
    ...
    <div id="customer_edit" class="edit_area">
      <ul class="list">
        <li>
          <fieldset>
            <legend>1.<?php echo $TEXT['info-customerinfo'] ?></legend> <input id="custid" type="hidden"> <label id="lbnikname" for="nikname">*<?php echo $TEXT['info-custname'] ?></label> <input id="nikname" type="text" class="itext disablebox" name="nikname" maxlength="50"> <label id="lbfullname" for="fullname">*<?php echo $TEXT['info-fullname'] ?></label> <input id="fullname" type="text" class="itext disablebox" name="fullname" maxlength="50"> <label id="lbcustmphone" for="custmphone">*<?php echo $TEXT['info-contactphone'] ?></label> <input id="custmphone" type="text" class="itext disablebox" name="custmphone" maxlength="50"> <label for="custremark"><?php echo $TEXT['info-remark'] ?></label> 
        ...
        <li id="customer_operat">
          <fieldset>
            ...
            <ul class="flat">
              <li><input id="cust_save" type="button" class="small button" disabled value="<?php echo $TEXT['button-save'] ?>"></li>
              <li><input id="cust_update" type="button" class="small button" disabled value="<?php echo $TEXT['button-update'] ?>"></li>
              <li><input id="cust_cancel" type="button" class="small button" disabled value="<?php echo $TEXT['button-cancel'] ?>"></li>
            </ul>
          </fieldset>
        </li>
      </ul>
  ...
  <div id="tab_mgrvehicle" class="tab_content">
    <div class="search_bar">
      <ul class="flat">
        <li><select id="mgrvehicle_item" class="iselect">
          <option value='1' selected='selected'>
            <?php echo $TEXT['info-objectflag'] ?>
          </option>
          <option value='2'>
            <?php echo $TEXT['info-deviceid'] ?>
          </option>
          <option value='3'>
            <?php echo $TEXT['info-simcard'] ?>
          </option>
          <option value='4'>
            <?php echo $TEXT['info-driver'] ?>
          </option>
        </select> <input id="mgrvehicle_cond" type="text" class="itext enablebox" maxlength="30"></li>
        ...
        <li><input id="dev_tips" type="text" class="ilabel" readonly="readonly"></li>
      </ul><!--
            <ul class="extend">
    ...
    <div id="dev_edit" class="edit_area">
      <ul class="list">
        <li>
          <fieldset>
            <legend>1.<?php echo $TEXT['info-customerinfo'] ?></legend> <label id="lblcinfo" for="cinfo">*<?php echo $TEXT['info-customerinfo'] ?></label> <select id="cinfo" class="iselect" name="cinfo">
            </select>
          </fieldset>
        </li>
        <li>
          <fieldset>
            <legend>2.<?php echo $TEXT['info-groupinfo'] ?></legend> <label id="lblginfo" for="ginfo">*<?php echo $TEXT['info-groupname'] ?></label> <select id="ginfo" class="iselect" name="ginfo">
            </select>
          </fieldset>
        </li>
        <li>
          <fieldset>
            ...
            <label id="lbdlist" for="dlist">*<?php echo $TEXT['info-driver'] ?></label> <select id="dlist" class="iselect disablebox" name="dlist">
            </select> <label id="lbloflag" for="oflag">*<?php echo $TEXT['info-objectflag'] ?></label> <input id="oflag" type="text" class="itext disablebox" name="oflag" maxlength="50"> <label id="lbluflag" for="uflag"><?php echo $TEXT['info-usedefflag'] ?></label> <input id="uflag" type="text" class="itext disablebox" name="uflag" maxlength="50"> <label for="remark"><?php echo $TEXT['info-remark'] ?></label> 
            <textarea id="remark" class="icontent disablebox" name="remark" maxlength="200"></textarea>
          </fieldset>
        </li>
        <li>
          <fieldset>
            <legend>4.<?php echo $TEXT['info-deviceinfo'] ?></legend> <label id="lbldtype" for="dtype">*<?php echo $TEXT['info-devicetype'] ?></label> <select id="dtype" class="iselect" name="dtype">
            </select> <label id="lbldstatus" for="dstate">*<?php echo $TEXT['info-devicestatus'] ?></label> <select id="dstate" class="iselect" name="dstate">
            </select>
            <div id="dev_devno">
              <label id="lbldevno" for="devno">*<?php echo $TEXT['info-deviceid'] ?></label> <input id="devno" type="text" class="itext disablebox" name="devno" maxlength="20">
            </div><label id="lblsimno" for="simno">*<?php echo $TEXT['info-simcard'] ?></label> <input id="simno" type="text" class="itext disablebox" name="simno" maxlength="20"> <!--Òþ²ØÉè±¸ÃÜÂë-->
             <label for="dpass" style="display:none;"><?php echo $TEXT['info-devicepass'] ?></label> <input id="dpass" style="display:none;" type="password" class="itext disablebox" name="dpass" maxlength="10"> <label for="ztime">*<?php echo $TEXT['info-timezone'] ?></label> <input id="ztime" type="text" class="itext disablebox" name="ztime" maxlength="6">
            <div id="dev_stamp">
              <label>*<?php echo $TEXT['info-installtime'] ?></label> <input id="stamp" type="text" class="itext disablebox" maxlength="10" readonly='true'>
            </div><label for="iaddr"><?php echo $TEXT['info-installaddr'] ?></label> <input id="iaddr" type="text" class="itext disablebox" name="iaddr" maxlength="64">
            <div id="last_stamp">
              <label>*<?php echo $TEXT['info-expiretime'] ?></label> <input id="estamp" type="text" class="itext disablebox" maxlength="10" readonly='true'>
            </div>
          </fieldset>
        </li>
        <li id="dev_operat">
          <fieldset>
            ...
            <ul class="flat">
              <li><input id="dev_save" type="button" class="small button" disabled value="<?php echo $TEXT['button-save'] ?>"></li>
              <li><input id="dev_update" type="button" class="small button" disabled value="<?php echo $TEXT['button-update'] ?>"></li>
              <li><input id="dev_cancel" type="button" class="small button" disabled value="<?php echo $TEXT['button-cancel'] ?>"></li>
            </ul>
          </fieldset>
        </li>
      </ul>
  ...
  <div id="tab_mgrdriver" class="tab_content">
    <div class="search_bar">
      <ul class="flat">
        <li><select id="mgrdriver_item" class="iselect">
          <option value='1' selected='selected'>
            <?php echo $TEXT['info-driver'] ?>
          </option>
          <option value='2'>
            <?php echo $TEXT['info-workid'] ?>
          </option>
          <option value='3'>
            <?php echo $TEXT['info-driver-rfid'] ?>
          </option>
          <option value='4'>
            <?php echo $TEXT['info-driver-tel'] ?>
          </option>
        </select> <input id="mgrdriver_cond" type="text" class="itext enablebox" maxlength="30"></li>
        ...
        <li><input id="driver_tips" type="text" class="ilabel" readonly="readonly"></li>
      </ul>
    </div>
    ...
    <div id="driver_edit" class="edit_area">
      <ul class="list">
        <li>
          <fieldset>
            <legend>1.<?php echo $TEXT['info-driverinfo'] ?></legend> <input id="driverid" type="hidden"> <label id="lbworkid" for="workid">*<?php echo $TEXT['info-workid'] ?></label> <input id="workid" type="text" class="itext disablebox must" name="workid" maxlength="50"> <label id="lbdriver" for="driver">*<?php echo $TEXT['info-driver'] ?></label> <input id="driver" type="text" class="itext disablebox must" name="driver" maxlength="50"> <label id="lbsex" for="sex">*<?php echo $TEXT['info-sex'] ?></label> <select id="sex" class="iselect must" name="sex">
            </select> <label id="lbprimary" for="primary">*<?php echo $TEXT['info-primary-driver'] ?></label> <select id="primary" class="iselect must" name="primary">
            </select> <label id="lbidcard" for="idcard"><?php echo $TEXT['info-driver-id-card'] ?></label> <input id="idcard" type="text" class="itext disablebox" name="idcard" maxlength="50"> <label id="lblicense" for="license"><?php echo $TEXT['info-driver-license'] ?></label> <input id="license" type="text" class="itext disablebox" name="license" maxlength="50"> <label id="lblicenseissuedate" for="licenseissuedate"><?php echo $TEXT['info-license-issue-date'] ?></label> <input id="licenseissuedate" type="text" class="itext itime disablebox" name="licenseissuedate" maxlength="50" readonly='true'> <label id="lblicenseexpiredate" for="licenseexpiredate"><?php echo $TEXT['info-license-expire-date'] ?></label> <input id="licenseexpiredate" type="text" class="itext itime disablebox" name="licenseexpiredate" maxlength="50" readonly='true'> <label id="lbdrivertel" for="drivertel"><?php echo $TEXT['info-driver-tel'] ?></label> <input id="drivertel" type="text" class="itext disablebox" name="drivertel" maxlength="50"> <label id="lbdriverrfid" for="driverrfid">*<?php echo $TEXT['info-driver-rfid'] ?></label> <input id="driverrfid" type="text" class="itext disablebox must" name="driverrfid" maxlength="50"> <label id="lbdrivercompany" for="drivercompany"><?php echo $TEXT['info-driver-company'] ?></label> <input id="drivercompany" type="text" class="itext disablebox" name="drivercompany" maxlength="50"> <label id="lbdriveraddr" for="driveraddr"><?php echo $TEXT['info-driver-add'] ?></label> <input id="driveraddr" type="text" class="itext disablebox" name="driveraddr" maxlength="50"> <label id="lbdrivermark" for="drivermark"><?php echo $TEXT['info-remark'] ?></label> 
            <textarea id="drivermark" class="icontent disablebox" name="drivermark" maxlength="200"></textarea> <label for="lbdriverph"><?php echo $TEXT['info-driver-photo'] ?></label>
            <div class="file_upload_box"><input id="driverphbtn" type="file" accept="image/jpeg" onchange="readFile(this)" style="cursor: pointer;" name="driverphbtn"> <img id="driverph" src="img/none%20driver.png" alt="none%20driver"></div>
          </fieldset>
        </li>
        <li id="driver_operat">
          <fieldset>
            <legend>2.<?php echo $TEXT['info-operatcmd'] ?></legend>
            <ul class="flat">
              <li><input id="driver_save" type="button" class="small button" disabled value="<?php echo $TEXT['button-save'] ?>"></li>
              <li><input id="driver_update" type="button" class="small button" disabled value="<?php echo $TEXT['button-update'] ?>"></li>
              <li><input id="driver_cancel" type="button" class="small button" disabled value="<?php echo $TEXT['button-cancel'] ?>"></li>
            </ul>
          </fieldset>
        </li>
      </ul>
  ...
  <div id="tab_mgrplace" class="tab_content">
    <div class="search_bar">
      <ul class="flat">
        <li><select id="mgrplace_item" class="iselect">
          <option value='1' selected='selected'>
            <?php echo $TEXT['info-placename'] ?>
          </option>
        </select> <input id="mgrplace_cond" type="text" class="itext enablebox" maxlength="30"></li>
        ...
        <li><input id="place_tips" type="text" class="ilabel" readonly="readonly"></li>
      </ul>
    </div>
    ...
    <div id="place_map" class="place_map">
    ...
    <div id="place_edit" class="edit_area">
      <ul class="list">
        <li>
          <fieldset>
            <legend>1.<?php echo $TEXT['info-placeinfo'] ?></legend> <label id="lbrpname" for="mgrplace_name">*<?php echo $TEXT['info-placename'] ?></label> <input id="mgrplace_name" type="text" class="itext disablebox must" name="mgrplace_name" maxlength="30"> <label id="lbrpcolor" for="mgrplace_color">*<?php echo $TEXT['info-placecolor'] ?></label> <input id="mgrplace_color" onchange="SetColor(this.jscolor)" type="text" class="icolor icolor disablebox must" name="mgrplace_color" maxlength="30" style="width: 127px;" value="006700" data-jscolor="{}"> <label id="lbrpenablespeed" for="mgrplace_enable_speed"><?php echo $TEXT['info-enable-speed-limit'] ?></label> <input id="mgrplace_enable_speed" type="checkbox" class="icheck disablebox" name="valid"> <label id="lbrpinsidespeed" for="mgrplace_inside_speed"><?php echo $TEXT['info-inside-speed-limit'] ?></label> <input id="mgrplace_inside_speed" type="text" class="itext disablebox" name="mgrplace_inside_speed" maxlength="30">
          </fieldset>
        </li>
        <li id="place_operat">
          <fieldset>
            <legend>2.<?php echo $TEXT['info-operatcmd'] ?></legend>
            <ul class="flat">
              <li><input id="place_save" type="button" class="small button" disabled value="<?php echo $TEXT['button-save'] ?>"></li>
              <li><input id="place_update" type="button" class="small button" disabled value="<?php echo $TEXT['button-update'] ?>"></li>
              <li><input id="place_cancel" type="button" class="small button" disabled value="<?php echo $TEXT['button-cancel'] ?>"></li>
            </ul>
          </fieldset>
        </li>
      </ul>
  ...
  <div id="tab_mgrtask" class="tab_content">
    <div class="search_bar">
      <ul class="flat">
        <li><select id="mgrtask_item" class="iselect">
          <option value='1' selected='selected'>
            <?php echo $TEXT['info-task-name'] ?>
          </option>
          <option value='2'>
            <?php echo $TEXT['info-objectflag'] ?>
          </option>
        </select> <input id="mgrtask_cond" type="text" class="itext enablebox" maxlength="30"></li>
        ...
        <li><input id="task_tips" type="text" class="ilabel" readonly="readonly"></li>
      </ul>
    </div>
    <div class="task_area">
    ...
    <div id="task_edit" class="edit_area">
      <ul class="list">
        <li>
          <fieldset>
            <legend>1.<?php echo $TEXT['info-taskinfo'] ?></legend> <input id="taskid" type="hidden"> <label id="lbtaskname" for="taskname">*<?php echo $TEXT['info-task-name'] ?></label> <input id="taskname" type="text" class="itext disablebox must" name="taskname" maxlength="50"> <label id="lbtaskasset" for="taskasset">*<?php echo $TEXT['info-objectflag'] ?></label> <select id="taskasset" class="iselect must" name="taskasset">
            </select> <label id="lbtaskpriority" for="taskpriority">*<?php echo $TEXT['info-task-priority'] ?></label> <select id="taskpriority" class="iselect must" name="taskpriority">
            </select> <label id="lbtaskstatus" for="taskstatus">*<?php echo $TEXT['info-task-status'] ?></label> <select id="taskstatus" class="iselect must" name="taskstatus">
            </select> <label id="lbtaskstartp" for="taskstartp"><?php echo $TEXT['info-task-start-place'] ?></label> <select id="taskstartp" class="iselect must" name="taskstartp">
            </select> <label id="lbtaskstartf" for="taskstartf">*<?php echo $TEXT['info-task-start-from'] ?></label> <input id="taskstartf" type="text" class="itext itime must disablebox" name="taskstartf" maxlength="50" readonly='true'> <label id="lbtaskstartt" for="taskstartt">*<?php echo $TEXT['info-task-start-to'] ?></label> <input id="taskstartt" type="text" class="itext itime must disablebox" name="taskstartt" maxlength="50" readonly='true'> <label id="lbtaskendp" for="taskendp"><?php echo $TEXT['info-task-end-place'] ?></label> <select id="taskendp" class="iselect must" name="taskendp">
            </select> <label id="lbtaskendf" for="taskendf">*<?php echo $TEXT['info-task-end-from'] ?></label> <input id="taskendf" type="text" class="itext itime must disablebox" name="taskendf" maxlength="50" readonly='true'> <label id="lbtaskendt" for="taskendt">*<?php echo $TEXT['info-task-end-to'] ?></label> <input id="taskendt" type="text" class="itext itime must disablebox" name="taskendt" maxlength="50" readonly='true'> <label id="lbtaskrepeat" for="taskrepeat"><?php echo $TEXT['info-task-repeat-task'] ?></label> <input id="taskrepeat" type="checkbox" class="icheck disablebox" name="taskrepeat"> <label id="ldaysinterval" for="daysinterval"><?php echo $TEXT['info-task-days-interval'] ?></label> <input id="daysinterval" type="text" class="itext disablebox" name="daysinterval" maxlength="30"> <label id="lbtaskr" for="taskr"><?php echo $TEXT['info-remark'] ?></label> 
        ...
        <li id="task_operat">
          <fieldset>
            <legend>2.<?php echo $TEXT['info-operatcmd'] ?></legend>
            <ul class="flat">
              <li><input id="task_save" type="button" class="small button" disabled value="<?php echo $TEXT['button-save'] ?>"></li>
              <li><input id="task_update" type="button" class="small button" disabled value="<?php echo $TEXT['button-update'] ?>"></li>
              <li><input id="task_cancel" type="button" class="small button" disabled value="<?php echo $TEXT['button-cancel'] ?>"></li>
            </ul>
          </fieldset>
        </li>
      </ul>
  ...
  <div id="tab_mgrexpense" class="tab_content">
    <div class="search_bar">
      <ul class="flat">
        <li><select id="mgrexpense_item" class="iselect">
          <option value='1' selected='selected'>
            <?php echo $TEXT['info-expense-name'] ?>
          </option>
          <option value='2'>
            <?php echo $TEXT['info-objectflag'] ?>
          </option>
        </select> <input id="mgrexpense_cond" type="text" class="itext enablebox" maxlength="30"></li>
        ...
        <li><input id="expense_tips" type="text" class="ilabel" readonly="readonly"></li>
      </ul>
    </div>
    ...
    <div id="expense_edit" class="edit_area">
      <ul class="list">
        <li>
          <fieldset>
            <legend>1.<?php echo $TEXT['info-expenseinfo'] ?></legend> <input id="expense_oid" type="hidden"> <label id="lbexpensename" for="expensename">*<?php echo $TEXT['info-expense-name'] ?></label> <input id="expensename" type="text" class="itext disablebox must" name="expensename" maxlength="50"> <label id="lbexpensedate" for="expensedate">*<?php echo $TEXT['info-expense-date'] ?></label> <input id="expensedate" type="text" class="itext itime must disablebox" name="expensedate" maxlength="50" readonly='true'> <label id="lbexpenseasset" for="expenseasset">*<?php echo $TEXT['info-objectflag'] ?></label> <select id="expenseasset" class="iselect must" name="expenseasset">
            </select> <label id="lbexpensequantity" for="expensequantity">*<?php echo $TEXT['info-expense-quantity'] ?></label> <input id="expensequantity" type="text" class="itext disablebox must" name="expensequantity" maxlength="50"> <label id="lbexpensecost" for="expensecost">*<?php echo $TEXT['info-expense-cost'] ?></label> <input id="expensecost" type="text" class="itext disablebox must" name="expensecost" maxlength="50"> <label id="lbexpensesupplier" for="expensesupplier"><?php echo $TEXT['info-expense-supplier'] ?></label> <input id="expensesupplier" type="text" class="itext disablebox" name="expensesupplier" maxlength="50"> <label id="lbexpensebuyer" for="expensebuyer"><?php echo $TEXT['info-expense-buyer'] ?></label> <input id="expensebuyer" type="text" class="itext disablebox" name="expensebuyer" maxlength="50"> <label id="lbexpenseodometer" for="expenseodometer"><?php echo $TEXT['info-expense-odometer'] ?></label> <input id="expenseodometer" type="text" class="itext disablebox" name="expenseodometer" maxlength="50"> <label id="lbexpenseenghour" for="expenseenghour"><?php echo $TEXT['info-expense-engine-hours'] ?></label> <input id="expenseenghour" type="text" class="itext disablebox" name="expenseenghour" maxlength="50"> <label id="lexpenserm" for="expenserm"><?php echo $TEXT['info-expense-description'] ?></label> 
        ...
        <li id="expense_operat">
          <fieldset>
            <legend>2.<?php echo $TEXT['info-operatcmd'] ?></legend>
            <ul class="flat">
              <li><input id="expense_save" type="button" class="small button" disabled value="<?php echo $TEXT['button-save'] ?>"></li>
              <li><input id="expense_update" type="button" class="small button" disabled value="<?php echo $TEXT['button-update'] ?>"></li>
              <li><input id="expense_cancel" type="button" class="small button" disabled value="<?php echo $TEXT['button-cancel'] ?>"></li>
            </ul>
          </fieldset>
        </li>
      </ul>
        ...
        <div class="content">
          <table border="0" cellpadding="0" cellspacing="0" style="padding: 0 10px">
            ...
            <tr>
              ...
              <td>
              <textarea id="cust_remark" class="icontent enablebox" maxlength="256"></textarea></td>
            </tr>
          </table>
        </div>
        <div class="footer">
          <input id="button_cancel" type="button" class="right small button" style="margin-left: 5px;" value="<?php echo $TEXT['button-cancel'] ?>"> <input id="button_ok" type="button" class="right small button" value="<?php echo $TEXT['button-ok'] ?>">
        </div>
      </div>
    </div>
  </div><!--new group-->
  <div id="dlg_newgroup" class="dialog" style="min-width: 200px;">
    <div class="out">
      <div class="in">
        ...
        <p><?php echo $TEXT['info-newgrouptips'] ?><span id="parent"></span>&nbsp;<select id="parent_edit" class="iselect" style="width: 153px;">
        </select></p>
        <div class="content">
          <table border="0" cellpadding="0" cellspacing="0" style="padding: 0 10px">
            <tr>
  ...
  <div id="dlg_services" class="dialog" style="min-width: 450px; _width: 550px;">
    <div class="out">
      <div class="in">
        ...
        <div class="content">
          <ul class="tabbar tab">
            <li target="#tab_baseservice" class="tab_active tab">
              <a href="#" class="tab" title="<?php echo $TEXT['info-service-main'] ?>"></a>
            </li>
            <li target="#tab_event" class="tab">
              <a href="#" class="tab" title="<?php echo $TEXT['info-service-customized-event'] ?>"></a>
            </li>
            <li target="#tab_accuracy" class="tab">
              <a href="#" class="tab" title="<?php echo $TEXT['info-service-accuracy'] ?>"></a>
            </li>
            <li target="#tab_sensor" class="tab">
              <a href="#" class="tab" title="<?php echo $TEXT['info-service-sensor'] ?>"></a>
            </li>
            <li target="#tab_maintenance" class="tab">
              <a href="#" class="tab" title="<?php echo $TEXT['info-maintenance-info'] ?>"></a>
            </li>
            <li target="#tab_place" class="tab">
              <a href="#" class="tab" title="<?php echo $TEXT['info-place'] ?>"></a>
            </li>
            <li target="#tab_notification" class="tab">
              <a href="#" class="tab" title="<?php echo $TEXT['info-notification'] ?>"></a>
            </li>
          </ul>
          <div id="tab_baseservice" class="tab_content" style="height: 250px; width: 650px">
            <table border="0" cellpadding="0" cellspacing="0" style="padding: 0 10px">
              ...
              <tr>
                ...
                <td><select id="statetable" name="statetable" class="iselect" multiple>
                  <option value="12293">
                    <?php echo $TEXT['3005'] ?>
                  </option>
                  <option value="12294">
          ...
          <div id="tab_event" class="tab_content" style="display:none; height: 250px; width: 650px">
            <div class="event_search_bar">
              <ul class="flat">
                <li class="tab"><select id="mgrevent_item" class="iselect">
                  <option value='1' selected='selected'>
                    <?php echo $TEXT['info-service-event-name'] ?>
                  </option>
                </select> <input id="mgrevent_cond" type="text" class="itext enablebox" maxlength="30"></li>
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="padding: 0 10px">
              <tr>
                ...
                <td><select id="odometer-by" class="iselect must" name="odometer-by">
                  <option value="0">
                    <?php echo $TEXT['info-by-off'] ?>
                  </option>
                  <option selected="selected" value="1">
                    <?php echo $TEXT['info-by-tracker'] ?>
                  </option>
                  <option value="2">
                    <?php echo $TEXT['info-by-server'] ?>
                  </option>
                </select></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><select id="detect-stops-using" class="iselect must" name="detect-stops-using">
                  <option value="0">
                    <?php echo $TEXT['info-detect-stops-using-gps'] ?>
                  </option>
                  <option value="1">
                    <?php echo $TEXT['info-detect-stops-using-acc'] ?>
                  </option>
                  <option value="2">
                    <?php echo $TEXT['info-detect-stops-using-gpsacc'] ?>
                  </option>
                </select></td>
              </tr>
              <tr>
                ...
                <td><select id="fuel-upload-type" class="iselect must" name="fuel-upload-type">
                  <option value="0">
                    <?php echo $TEXT['info-fuel-upload-liter'] ?>
                  </option>
                  <option value="1">
                    <?php echo $TEXT['info-fuel-upload-per'] ?>
                  </option>
                  <option value="2">
                    <?php echo $TEXT['info-fuel-upload-ad'] ?>
                  </option>
                </select></td>
              </tr>
              <tr>
          ...
          <div id="tab_sensor" class="tab_content" style="display:none; height: 250px; width: 650px">
            <div class="sensor_search_bar">
              <ul class="flat">
                <li class="tab"><select id="mgrsensor_item" class="iselect">
                  <option value='1' selected='selected'>
                    <?php echo $TEXT['info-service-sensor-name'] ?>
                  </option>
                </select> <input id="mgrsensor_cond" type="text" class="itext enablebox" maxlength="30"></li>
          ...
          <div id="tab_place" class="tab_content" style="overflow:auto; display:none; height: 250px; width: 650px">
            <div class="place_search_bar">
              <ul class="flat">
                <li class="tab"><select id="service_place_item" class="iselect">
                  <option value='1' selected='selected'>
                    <?php echo $TEXT['info-placename'] ?>
                  </option>
                </select> <input id="service_place_cond" type="text" class="itext enablebox" maxlength="30"></li>
  ...
  <div id="dlg_event" class="dialog" style="min-width: 450px; _width: 700px;">
    <div class="out">
      <div class="in">
        ...
        <div class="content">
          <ul class="tabbar tab">
            <li target="#tab_event_main" class="tab_active tab">
              <a href="#" class="tab" title="<?php echo $TEXT['info-service-event-main'] ?>"></a>
            </li>
            <li target="#tab_event_time" class="tab">
              <a href="#" class="tab" title="<?php echo $TEXT['info-service-event-trigger'] ?>"></a>
            </li>
            <li target="#tab_event_notification" class="tab">
              <a href="#" class="tab" title="<?php echo $TEXT['info-service-event-notification'] ?>"></a>
            </li>
            <li target="#tab_event_control" class="tab">
              <a href="#" class="tab" title="<?php echo $TEXT['info-service-event-control'] ?>"></a>
            </li>
          </ul>
                ...
                <td width="50%" valign="top">
                  <table border="0" cellpadding="0" cellspacing="0" style="padding: 0 10px">
                    ...
                    <tr>
                      ...
                      <td><select id="event_type" class="iselect must">
                        <!--option value format = 
                                                                                                -> event(dec), 
                        ...
                        <option value="4107,66,2">
                          <?php echo $TEXT['100B'] ?>
                        </option>
                        <option value="12326,66,4">
                          <?php echo $TEXT['3026'] ?>
                        </option>
                        <option value="4110">
                          <?php echo $TEXT['100E'] ?>
                        ...
                        <option value="12324,7,1">
                          <?php echo $TEXT['3024'] ?>
                        </option>
                        <option value="12325,8,1">
                          <?php echo $TEXT['3025'] ?>
                        </option>
                        <option value="12328,104,1">
                          <?php echo $TEXT['3028'] ?>
                        </option>
                        <option value="4164">
                          <?php echo $TEXT['1044'] ?>
                    ...
                    <tr>
                      ...
                      <td><select id="event_depending_place" class="iselect place_related">
                        <option value="0">
                          <?php echo $TEXT['info-service-event-depending-place-off'] ?>
                        </option>
                        <option value="1">
                          <?php echo $TEXT['info-service-event-in-place'] ?>
                        </option>
                        <option value="2">
                          <?php echo $TEXT['info-service-event-out-place'] ?>
                        </option>
                      </select></td>
                    </tr>
                    <tr>
                      <td width="50%"><?php echo $TEXT['info-service-event-place'] ?></td>
                      <td><select id="event_place" class="iselect tab place_related" style="height: 24px;" multiple="multiple">
                      </select></td>
                    </tr>
                    <tr>
                  ...
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" style="padding: 0 10px">
                    ...
                    <tr>
                      <td>
                        ...
                        <table>
                          <tr>
                            <td><select id="event_parameters_item" class="iselect param_related" style="width: 100px;">
                            </select></td>
                            <td><select id="event_parameters_symbol" class="iselect param_related" style="width: 50px;">
                              <option value="-1">
                              </option>
                              <option value="0">
                                =
          ...
          <div id="tab_event_time" class="tab_content" style="display: none; height: 300px; width: 700px">
            <table id="event_time_table" width="100%">
              ...
              <tr>
                ...
                <td width="50%"><input id="event_time_daytime_mon_enable" type="checkbox" class="icheckbox daytime"> <select id="event_time_daytime_monday_from" class="iselect daytime" style="width: 60px;">
                </select> <select id="event_time_daytime_monday_to" class="iselect daytime" style="width: 60px;">
                </select></td>
              </tr>
              <tr>
                <td width="50%"><?php echo $TEXT['info-service-event-time-tuesday'] ?></td>
                <td width="50%"><input id="event_time_daytime_tue_enable" type="checkbox" class="icheckbox daytime"> <select id="event_time_daytime_tuesday_from" class="iselect daytime" style="width: 60px;">
                </select> <select id="event_time_daytime_tuesday_to" class="iselect daytime" style="width: 60px;">
                </select></td>
              </tr>
              <tr>
                <td width="50%"><?php echo $TEXT['info-service-event-time-wednesday'] ?></td>
                <td width="50%"><input id="event_time_daytime_wed_enable" type="checkbox" class="icheckbox daytime"> <select id="event_time_daytime_wednesday_from" class="iselect daytime" style="width: 60px;">
                </select> <select id="event_time_daytime_wednesday_to" class="iselect daytime" style="width: 60px;">
                </select></td>
              </tr>
              <tr>
                <td width="50%"><?php echo $TEXT['info-service-event-time-thursday'] ?></td>
                <td width="50%"><input id="event_time_daytime_thu_enable" type="checkbox" class="icheckbox daytime"> <select id="event_time_daytime_thursday_from" class="iselect daytime" style="width: 60px;">
                </select> <select id="event_time_daytime_thursday_to" class="iselect daytime" style="width: 60px;">
                </select></td>
              </tr>
              <tr>
                <td width="50%"><?php echo $TEXT['info-service-event-time-friday'] ?></td>
                <td width="50%"><input id="event_time_daytime_fri_enable" type="checkbox" class="icheckbox daytime"> <select id="event_time_daytime_friday_from" class="iselect daytime" style="width: 60px;">
                </select> <select id="event_time_daytime_friday_to" class="iselect daytime" style="width: 60px;">
                </select></td>
              </tr>
              <tr>
                <td width="50%"><?php echo $TEXT['info-service-event-time-saturday'] ?></td>
                <td width="50%"><input id="event_time_daytime_sat_enable" type="checkbox" class="icheckbox daytime"> <select id="event_time_daytime_saturday_from" class="iselect daytime" style="width: 60px;">
                </select> <select id="event_time_daytime_saturday_to" class="iselect daytime" style="width: 60px;">
                </select></td>
              </tr>
              <tr>
                <td width="50%"><?php echo $TEXT['info-service-event-time-sunday'] ?></td>
                <td width="50%"><input id="event_time_daytime_sun_enable" type="checkbox" class="icheckbox daytime"> <select id="event_time_daytime_sunday_from" class="iselect daytime" style="width: 60px;">
                </select> <select id="event_time_daytime_sunday_to" class="iselect daytime" style="width: 60px;">
                </select></td>
              </tr>
            </table>
          </div>
          <div id="tab_event_notification" class="tab_content" style="display:none; height: 300px; width: 700px">
            <table border="0" cellpadding="0" cellspacing="0" style="padding: 0 10px">
              ...
              <tr>
                ...
                <td><input id="event_push_notification_enable" type="checkbox" class="icheckbox"></td>
              </tr>
              <tr>
                <td><?php echo $TEXT['js-notification-email'] ?></td>
                <td><input id="event_notification_email_enable" type="checkbox" class="icheckbox"> <input id="event_notification_email" type="text" class="itext enablebox" style="width:250px;"><?php echo $TEXT['info-notification-email-hint'] ?></td>
              </tr>
              <tr>
                <td><?php echo $TEXT['js-notification-sms'] ?></td>
                <td><input id="event_notification_sms_enable" type="checkbox" class="icheckbox"> <input id="event_notification_sms" type="text" class="itext enablebox" style="width:250px;"><?php echo $TEXT['info-notification-sms-hint'] ?></td>
              </tr>
              <tr>
                <td><?php echo $TEXT['js-notification-telegram'] ?></td>
                <td><input id="event_notification_telegram_enable" type="checkbox" class="icheckbox"> <input id="event_notification_telegram" type="text" class="itext enablebox" style="width:250px;"><?php echo $TEXT['info-notification-telegram-hint'] ?></td>
              </tr>
              <tr>
                <td></td>
              </tr>
              ...
              <tr>
                ...
                <td><input id="event_event_arrow_enable" type="checkbox" class="icheckbox"> <select id="event_event_arrow" class="iselect" style="width: 150px;">
                  <option value="black">
                    <?php echo $TEXT['info-service-event-list-color-black'] ?>
                  </option>
                  <option value="blue">
                    <?php echo $TEXT['info-service-event-list-color-blue'] ?>
                  </option>
                  <option value="green">
                    <?php echo $TEXT['info-service-event-list-color-green'] ?>
                  </option>
                  <option value="gray">
                    <?php echo $TEXT['info-service-event-list-color-gray'] ?>
                  </option>
                  <option value="orange">
                    <?php echo $TEXT['info-service-event-list-color-orange'] ?>
                  </option>
                  <option value="purple">
                    <?php echo $TEXT['info-service-event-list-color-purple'] ?>
                  </option>
                  <option value="red">
                    <?php echo $TEXT['info-service-event-list-color-red'] ?>
                  </option>
                  <option selected="selected" value="yellow">
                    <?php echo $TEXT['info-service-event-list-color-yellow'] ?>
                  </option>
                </select></td>
              </tr>
              <tr>
                <td><?php echo $TEXT['info-service-event-list-color'] ?></td>
                <td><input id="event_event_list_color_enable" type="checkbox" class="icheckbox"> <input id="event_event_list_color" class="icolor enablebox" style="width:60px;" value="FFFF00" data-jscolor="{}"></td>
              </tr>
            </table>
          </div>
          <div id="tab_event_control" class="tab_content" style="display:none; height: 300px; width: 700px">
            <table border="0" cellpadding="0" cellspacing="0" style="padding: 0 10px">
              ...
              <tr>
                ...
                <td><select id="event_control_command" class="iselect" style="width: 200px;">
                  <option value="-1">
                  </option><!--<option value="19"><?php echo $TEXT['info-cmd-custom-content-command'] ?></option>-->
                  <option value="1">
                    <?php echo $TEXT['info-cmd-poll-position'] ?>
                  </option>
                  <option value="6">
                    <?php echo $TEXT['info-cmd-enable-immobilizer'] ?>
                  </option>
                  <option value="7">
                    <?php echo $TEXT['info-cmd-disable-immobilizer'] ?>
                  </option>
                  <option value="653">
                    <?php echo $TEXT['info-cmd-arm'] ?>
                  </option>
                  <option value="665">
                    <?php echo $TEXT['info-cmd-disarm'] ?>
                  </option>
                  <option value="4">
                    <?php echo $TEXT['info-cmd-lock-door'] ?>
                  </option>
                  <option value="5">
                    <?php echo $TEXT['info-cmd-unlock-door'] ?>
                  </option>
                  <option value="666">
                    <?php echo $TEXT['info-cmd-take-photo'] ?>
                  </option>
                  <option value="16">
                    <?php echo $TEXT['info-cmd-make-a-call'] ?>
                  </option>
                  <option value="23">
                    <?php echo $TEXT['info-cmd-voice-monitor'] ?>
                  </option>
                  <option value="35">
                    <?php echo $TEXT['info-cmd-voice-record'] ?>
                  </option>
                </select></td>
              </tr>
              <tr>
                <td><?php echo $TEXT['info-service-event-control-gateway'] ?></td>
                <td><select id="event_control_gateway" class="iselect" style="width: 200px;">
                  <option value="1">
                    <?php echo $TEXT['info-service-event-control-gateway-gprs'] ?>
                  </option>
                  <option value="2">
                    <?php echo $TEXT['info-service-event-control-gateway-sms'] ?>
                  </option>
                </select></td>
              </tr>
              <tr>
                <td><?php echo $TEXT['info-service-event-control-code-type'] ?></td>
                <td><select id="event_control_code_type" class="iselect" style="width: 200px;">
                  <option value="1">
                    <?php echo $TEXT['info-service-event-control-code-type-ascii'] ?>
                  </option>
                  <option value="2">
                    <?php echo $TEXT['info-service-event-control-code-type-hex'] ?>
                  </option>
                </select></td>
              </tr>
              <tr>
                ...
                <td width="50%" valign="top">
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" style="padding: 0 10px">
                    ...
                    <tr>
                      ...
                      <td width="50%"><select id="sensor_target" class="iselect">
                      </select></td>
                    </tr>
                    <tr>
                      <td width="50%"><?php echo $TEXT['info-service-sensor-element'] ?></td>
                      <td width="50%"><!--Element type
                                                                                        1:digital
                                                                                        2:formula
                                                                                        3:dictionary(option)
  ...
  <div id="mnuOperat" class="mnuOperat" style="display: none;">
    <ul>
      <li id="export_xls" style="border-top:3px solid #2982D6; width: 150px; cursor: pointer;" onclick="doExport(1);">
        <a style="pointer-events: none; padding-left: 25px; background: transparent url('img/xls.svg') no-repeat 4px center; background-size: 18px 18px;" href="#"><?php echo $TEXT['button-export-xls'] ?></a>
      </li><!--<li id="export_pdf" style="width: 150px;" onClick="doExport(7);"><a style="padding-left: 25px; background: transparent url('img/pdf.svg') no-repeat 4px center; background-size: 18px 18px;" href="#"><?php echo $TEXT['button-export-pdf'] ?></a></li>-->
      <li id="export_html" style="width: 150px; cursor: pointer;" onclick="doExport(3);">
        <a style="pointer-events: none; padding-left: 25px; background: transparent url('img/html.svg') no-repeat 4px center; background-size: 18px 18px;" href="#"><?php echo $TEXT['button-export-html'] ?></a>
      </li>
      <li id="export_csv" style="width: 150px; cursor: pointer;" onclick="doExport(4);">
        <a style="pointer-events: none; padding-left: 25px; background: transparent url('img/csv.svg') no-repeat 4px center; background-size: 18px 18px;" href="#"><?php echo $TEXT['button-export-csv'] ?></a>
      </li>
      <li id="export_doc" style="width: 150px; cursor: pointer;" onclick="doExport(5);">
        <a style="pointer-events: none; padding-left: 25px; background: transparent url('img/doc.svg') no-repeat 4px center; background-size: 18px 18px;" href="#"><?php echo $TEXT['button-export-doc'] ?></a>
      </li>
      <li id="export_txt" style="width: 150px; cursor: pointer;" onclick="doExport(6);">
        <a style="pointer-events: none; padding-left: 25px; background: transparent url('img/txt.svg') no-repeat 4px center; background-size: 18px 18px;" href="#"><?php echo $TEXT['button-export-txt'] ?></a>
      </li>
    </ul>
  </div>
</body>
