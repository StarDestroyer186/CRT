...
<head>
    ...
    <style type="text/css">
        ...
        .tab_status td:not(.scmd):not(.speedometer):not(.lastEvent):not(.lastMa):not(.lastTa) {
...
<body onload="oninit();" onunload="onfree();" onContextMenu="return true">
    ...
    <div id="container">
        ...
        <div id="geo">
            <ul>
                <li><!--<span id="loadmapwait"><?php echo $TEXT['map-loading'] ?></span>--></li>
                <li id="timeout" style="display: none;"></li>
                <li><img id="click_show_add" src="img/address.png" /></li>
                <li id="dev_flag"></li>
                <li id="address"></li>
            </ul>
        </div>
    ...
    <div id="dlg_sendcmd" class="dialog" style="width: 400px;">
        <div class="out">
            <div class="in">
                <h3 onmousedown="dragstart('dlg_sendcmd', event)" onmousemove="dragmove(event)"><?php echo $TEXT['navi-sendcmd'] ?></h3>
    ...
    <div id="dlg_altinfo" class="dialog" style="width: 450px;">
        <div class="out">
            <div class="in">
                <h3 onmousedown="dragstart('dlg_altinfo', event)" onmousemove="dragmove(event)"><?php echo $TEXT['navi-alarminfo'] ?></h3>
    ...
    <div id="dlg_objstatechart" class="dialog" style="position: absolute; width: 90%; padding: 0px 0px; margin: 0px;">
        <div class="out">
            <div class="in">
                <h3 onmousedown="dragstart('dlg_objstatechart', event)" onmousemove="dragmove(event)"><?php echo $TEXT['navi-objstatechartinfo'] ?></h3>
                <p id="title"></p>
                <table border="0" cellpadding="0" cellspacing="0" style="padding: 0px 0px; margin: 0px; width: 100%;">
                    <tr>
                        <td style="border='none'; align='top'; width: 25%;">
                            <div id="sta_on_off_exp" style="min-height: 240px;"></div>
                        </td>
                        <td style=" border='none'; align='top'; width: 25%;">
                            <div id="sta_mov_sti_alm" style="min-height: 240px;"></div>
                        </td>
                        <td style=" border='none'; align='top'; width: 25%;">
                            <div id="sta_speed_range" style="min-height: 240px;"></div>
                        </td>
                        <td style=" border='none'; align='top'; width: 25%;">
                            <div id="sta_exp_time" style="min-height: 240px;"></div>
                        </td>
                    </tr>
                    <tr>
                        <td style="border: 1px solid #369; border-right: none; align='top'; width: 25%;">
