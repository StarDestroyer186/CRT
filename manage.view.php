...
<style type="text/css">
html, body { margin: 0; padding: 0; width: 100%; height: 100%; font-size: 12px; font-family: Arial, Tahoma; color:#000 !important; overflow: hidden; }
#manage { position: absolute; left: 0; top: 0;right: 0;bottom: 0; border: 1px solid #999; }
.tab_report { width: 100%; border-collapse: collapse; }
.tab_report a { padding: 2px 4px; }
.tab_report th { border-left: 1px solid #ccc; background-color:#D5D5D5; font-size:12px; line-height:120%; font-weight:bold; padding:4px; text-align:left; position: sticky; top: 0; z-index: 1; }
.tab_report td { border: 1px solid #D5D5D5; font-size:12px; padding: 3px; }
...
.user_area { position: absolute; margin: 0; border: 1px solid #999; overflow-y: scroll; left: 4px; top:68px; right: 666px; bottom: 4px;}
.group_area { position: absolute; margin: 0; border: 1px solid #999; overflow: none; width: 300px; top:68px; right: 360px; bottom: 4px;}
.device_area { position: absolute; margin: 0; border: 1px solid #999; overflow-y: scroll; left: 4px; top:68px; right: 360px; bottom: 4px;}
.device_area table { table-layout: fixed; }
.device_area td { word-wrap: break-word; }
.customer_area { position: absolute; margin: 0; border: 1px solid #999; overflow-y: scroll; left: 4px; top:68px; right: 360px; bottom: 4px;}
.driver_area { position: absolute; margin: 0; border: 1px solid #999; overflow-y: scroll; left: 4px; top:68px; right: 360px; bottom: 4px;}
.place_area { position: absolute; margin: 0; border: 1px solid #999; overflow-y: scroll; left: 4px; top:68px; width: 380px; bottom: 4px;}
.task_area { position: absolute; margin: 0; border: 1px solid #999; overflow-y: scroll; left: 4px; top:68px; right: 360px; bottom: 4px;}
.expense_area { position: absolute; margin: 0; border: 1px solid #999; overflow-y: scroll; left: 4px; top:68px; right: 360px; bottom: 4px;}
.edit_area { position: absolute; margin: 0; border: 1px solid #999; overflow-y: scroll; width: 350px; top:68px; right: 4px; bottom: 4px; }
.purview_area { position: absolute; margin: 0; border: 1px solid #999; overflow-y: scroll; width: 370px; top:68px; right: 4px; bottom: 4px;}
.command_area { position: absolute; margin: 0; border: 1px solid #999; overflow: none; width: 280px; top:68px; right: 380px; bottom: 4px;}
.event_search_bar { position: absolute; left: 10px; top: 60px; right: 10px; height: 32px; border: 1px solid #ccc; z-index: 1; }
.sensor_search_bar { position: absolute; left: 10px; top: 60px; right: 10px; height: 32px; border: 1px solid #ccc; z-index: 1; }
.event_area { position: absolute; margin: 0; border: 1px solid #999; overflow-y: scroll; left: 10px; top:100px; right: 10px; bottom: 40px;}
.service_place_area { position: absolute; margin: 0; border: 1px solid #999; overflow-y: scroll; left: 10px; top:100px; right: 10px; bottom: 40px;}
.place_map { position: absolute; margin: 0; border: 1px solid #999;  left: 390px; top:68px; right: 360px; bottom: 4px;}
.oddcolor { background-color: #EEE; }
.button { float: left; margin-top: 2px; height: 23px;  }
fieldset { border: 1px solid #999; margin: 2px; padding: 2px 6px 6px 6px;}
...
.itext { margin: 2px; width: 165px; height: 20px; font-size: 12px; line-height: 20px; font-weight: normal; }
.iselect { margin: 1px 2px; width: 170px; height: 24px; line-height:24px; font-size: 12px; font-weight: normal;  -webkit-appearance: menulist-button;}
.icontent { margin: 1px 2px; width: 165px; height: 50px; font-size: 12px; line-height: 20px; font-weight: normal; overflow-y: auto;}
.icheck { margin: 2px; margin-right: 150px; height: 20px; font-size: 12px; line-height: 20px; font-weight: normal; }
.need { color: #f90; }
.must { border: 1px solid #666; color: #000;}
input[type=text]:disabled, select:disabled, textarea:disabled{ background-color:#fff}
.edit { color: #000; }
.noedit { color: #999; }
...
.stopped { background:transparent url(img/user_offline.png) no-repeat 8px center;  }
ul.list li label{ float: left; display: inline; width: 125px; line-height: 20px; margin: 2px 8px 2px 2px; text-align: right; }
ul.flat li { float: left; list-style: none; text-decoration: none; padding: 2px;}
ul.flat li label { margin: auto 4px;}
ul.extend li { float: right; list-style: none; text-decoration: none; line-height: 24px; margin: auto 4px; padding: 4px;}
.dialog table td, .dialog p { white-space:nowrap; }
.itime { background: #fff url(img/date.png) no-repeat right center; background-size: 16px 16px; }
.icolor { margin: 2px; height: 20px; font-size: 12px; line-height: 20px; font-weight: normal; }
.file_upload_box{ position: relative;}
.file_upload_box input[type=file] { opacity:0; filter:alpha(opacity=0); height: 80px; width: 89px; position: absolute; top: 0; left: 125px; z-index: 9; }
.device_status_in_repair{ display:block; background:#f00; border-radius:50%; width:8px; height:8px; top:0px; right:0px; position:absolute; }
#event_time_table tr td { height: 20px; margin: 0px; padding: 0px; }
#parameters_and_sensors tr th { text-align:center;  }
#parameters_and_sensors tr td { text-align:center;  }
#event_time_week_day { border-collapse:separate; border-spacing:0px;  }
#event_time_week_day tr td { height: 10px; margin: 0px; padding: 0px; text-align:center;}
#customized_event th{ text-align:center; }
#customized_event td{ text-align:center; height: 20px;}
...
<div id="dlg_newcustomer" class="dialog" style="min-width: 200px;">
    <div class="out">
        <div class="in">
            <h3 onmousedown="dragstart('dlg_newcustomer', event)"
                onmousemove="dragmove(event)"><?php echo $TEXT['info-addcustomer']?></h3>
...
<div id="dlg_newgroup" class="dialog" style="min-width: 200px;">
    <div class="out">
        <div class="in">
            <h3 onmousedown="dragstart('dlg_newgroup', event)"
                onmousemove="dragmove(event)"><?php echo $TEXT['info-groupinfo']?></h3>
		...
		<div class="in">
			...
			<div class="content" >
				...
				<div id="tab_notification" class="tab_content" style="display:none; height: 250px; width: 650px">
					<table border="0" cellpadding="0" cellspacing="0" style="padding: 0 10px">
						<tr>
							<td><label><?php echo $TEXT['info-enable-notification']?></label></td><td align="left"><input id="enable_notification" type="checkbox" class="icheckbox" name="enable_notification" /></td>							
						</tr>
						<tr>
							<td><?php echo $TEXT['js-notification-email']?></td><td><input id="notification_email" type="text" class="itext enablebox" style="width:250px;"/><?php echo $TEXT['info-notification-email-hint']?></td>
						</tr>
						<tr>
							<td><?php echo $TEXT['js-notification-sms']?></td><td><input id="notification_sms" type="text" class="itext enablebox" style="width:250px;"/><?php echo $TEXT['info-notification-sms-hint']?></td>
						</tr>
						<tr>
							<td><?php echo $TEXT['js-notification-telegram']?></td><td><input id="notification_telegram" type="text" class="itext enablebox" style="width:250px;"/><?php echo $TEXT['info-notification-telegram-hint']?></td>
						</tr>
					</table>
				</div>
			</div>
		...
		<div class="in">
			...
			<div class="content">
				...
				<div id="tab_event_control" class="tab_content" style="display:none; height: 300px; width: 700px">
					<table border="0" cellpadding="0" cellspacing="0" style="padding: 0 10px">
						<tr>
							<td><label><?php echo $TEXT['info-service-event-control-enable']?></label></td><td align="left"><input id="event_control_enable" type="checkbox" class="icheckbox"/></td>							
						</tr>
						<tr>
