...
<head>
    ...
    <script type="text/javascript"
        src="js/<?php echo $last_name['devicelist.js'] ?>?v=<?php echo $last_ver['devicelist.js'] ?>"></script>
    ...
    <script type="text/javascript"
        src="map/<?php echo $last_name['map.operat.js'] ?>?v=<?php echo $last_ver['map.operat.js'] ?>"></script>
    <script type="text/javascript"
        src="map/<?php echo $last_name['map.leaflet.js'] ?>?v=<?php echo $last_ver['map.leaflet.js'] ?>"></script>
...
/*            border: 1px solid #999;*/
        ...
        ul.list li label.statisticsval {
            float: right;
            display: block;
            width: 90px;
            color: #000;
        ...
        .tab_report td.fixed {
            color: #ccc;
            background: url(img/ajax-loader.gif) no-repeat 4px center;
            margin-left: 20px;
        }

        .tab_report td.success {
            color: #0b0;
        }
...
<body onload="oninit();" onunload="onfree();">
    <div id="search_bar">
        <ul class="list">
            <li style="padding: 4px 7px;">
                <fieldset>
                    <legend>1.
                        <?php echo $TEXT['info-searchinfo'] ?>
                    </legend>
                    <label for="device">*
                    ...
                    <label for="day">*
                        <?php echo $TEXT['info-daterange'] ?>
                    </label>
                    <select id="day" class="iselect" name="day">
                        <option value='1/24' selected='selected'>
                            <?php echo $TEXT['info-daterange-hour'] ?>
                        </option>
                        <option value='1/12'>
                            <?php echo $TEXT['info-daterange-2hour'] ?>
                        </option>
                        <option value='0.1'>
                            <?php echo $TEXT['info-daterange-day'] ?>
                        </option>
                        <option value='0.2'>
                            <?php echo $TEXT['info-daterange-yesterday'] ?>
                        </option>
                        <option value='1'>
                            <?php echo $TEXT['info-daterange-1day'] ?>
                        </option>
                        <option value='2'>
                            <?php echo $TEXT['info-daterange-2day'] ?>
                        </option>
                        <option value='3'>
                            <?php echo $TEXT['info-daterange-3day'] ?>
                        </option>
                        <option value='7'>
                            <?php echo $TEXT['info-daterange-week'] ?>
                        </option>
                        <option value='14'>
                            <?php echo $TEXT['info-daterange-2week'] ?>
                        </option>
                        <option value='-1'>
                            <?php echo $TEXT['info-daterange-usedef'] ?>
                        </option>
                    </select>
                    <div id="seltime" style="display: none;">
                        <label for="time1">*
                            <?php echo $TEXT['info-starttime'] ?>
                        </label>
                        <input id="time1" type="text" autocomplete="off" class="itext itime" name="time1" maxlength="19"
                            onclick="showcalendar(event, this, true)" />
                        <label for="time2">*
                            <?php echo $TEXT['info-endtime'] ?>
                        </label>
                        <input id="time2" type="text" autocomplete="off" class="itext itime" name="time2" maxlength="19"
                            onclick="showcalendar(event, this, true)" />
                    </div>
                    <label>
                        <?php echo $TEXT['info-stop-duration'] ?>
                    </label>
                    <select id="stop_duration" class="iselect" name="stoptime">
                        <option value='1'>
                            <?php echo $TEXT['info-1min'] ?>
                        </option>
                        <option value='2'>
                            <?php echo $TEXT['info-2min'] ?>
                        </option>
                        <option value='5'>
                            <?php echo $TEXT['info-5min'] ?>
                        </option>
                        <option value='10'>
                            <?php echo $TEXT['info-10min'] ?>
                        </option>
                        <option value='20' selected='selected'>
                            <?php echo $TEXT['info-20min'] ?>
                        </option>
                        <option value='30'>
                            <?php echo $TEXT['info-30min'] ?>
                        </option>
                        <option value='60'>
                            <?php echo $TEXT['info-60min'] ?>
                        </option>
                        <option value='120'>
                            <?php echo $TEXT['info-120min'] ?>
                        </option>
                        <option value='300'>
                            <?php echo $TEXT['info-300min'] ?>
                        </option>
                    </select>
                    <label>
                        <?php echo $TEXT['js-position-type'] ?>
                    </label>
                    <select id="position_type" class="iselect" name="positiontype">
                        <option value='1' selected='selected'>
                            <?php echo $TEXT['js-position-type-gps'] ?>
                        </option>
                        <option value='2'>
                            <?php echo $TEXT['js-position-type-gps-lbs'] ?>
                        </option>
                    </select>
                    <label>
                        <?php echo $TEXT['js-playback-type'] ?>
                    </label>
                    <select id="playback_type" class="iselect" name="playbacktype">
                        <option value='1' selected='selected'>
                            <?php echo $TEXT['js-playback-type-track'] ?>
                        </option>
                        <option value='2'>
                            <?php echo $TEXT['js-playback-type-track-route'] ?>
                        </option>
                        <option value='3'>
                            <?php echo $TEXT['js-playback-type-track-route-statistics'] ?>
                        </option>
                    </select>
            ...
            <li style="padding: 4px 7px;">
                <fieldset>
                    <legend>2.
                        <?php echo $TEXT['info-operatcmd'] ?>
                    </legend>
                    <input id="search" type="button" class="small button" disabled
                        title="<?php echo $TEXT['status-mapnotloaded'] ?>"
                        value="<?php echo $TEXT['button-search'] ?>" />
                    <input id="play" type="button" class="small button" disabled
                        value="<?php echo $TEXT['button-play'] ?>" />
                    <input id="export" type="button" class="small button" disabled
                        value="<?php echo $TEXT['button-export'] ?>" />
                </fieldset>
            </li>
            <li style="padding: 4px 7px;">
                <fieldset>
                    <legend>3.
                        <?php echo $TEXT['info-playspeed'] ?>
                    </legend>
                    <label for="speed">*
                        <?php echo $TEXT['info-playspeed'] ?>
                    </label>
                    <select id="speed" class="iselect" name="speed">
                        <option value='1000' selected='selected'>
                            <?php echo $TEXT['info-playspeed-normal'] ?>
                        </option>
                        <option value='500'>
                            <?php echo $TEXT['info-playspeed-quick'] ?>
                        </option>
                        <option value='100'>
                            <?php echo $TEXT['info-playspeed-fast'] ?>
                        </option>
                    </select>
            ...
            <li style="padding: 4px 7px;">
                <fieldset id="fieldset_pro">
                    <legend>5.
                        <?php echo $TEXT['navi-targetstatus'] ?>
                    </legend>
                    <ul class="tabbar">
                        <li target="#tab_process" class="tab_active"><a href="#"
                                title="<?php echo $TEXT['navi-his-process'] ?>"></a></li>
                        <li target="#tab_statistics"><a href="#" title="<?php echo $TEXT['navi-his-statistics'] ?>"></a>
                        </li>
                    </ul>
                    <div id="tab_process" class="tab_content"></div>

                    <div id="tab_statistics" class="tab_content">
                        <label id="distance_text" class="statistics">
                            <?php echo $TEXT['navi-distance'] ?>
                        </label>
                        <label id="distance" class="statisticsval"></label><br>
                        <label class="statistics">
                            <?php echo $TEXT['navi-divtime'] ?>
                        </label>
                        <label id="divtime" class="statisticsval"></label><br>
                        <label class="statistics">
                            <?php echo $TEXT['navi-stoptime'] ?>
                        </label>
                        <label id="stoptime" class="statisticsval"></label><br>
                        <label id="avspeed_text" class="statistics">
                            <?php echo $TEXT['navi-avspeed'] ?>
                        </label>
                        <label id="avspeed" class="statisticsval"></label><br>
                        <label id="maxspeed_text" class="statistics">
                            <?php echo $TEXT['navi-maxspeed'] ?>
                        </label>
                        <label id="maxspeed" class="statisticsval"></label><br>
                        <label class="statistics">
                            <?php echo $TEXT['navi-idletime'] ?>
                        </label>
                        <label id="idletime" class="statisticsval"></label><br>
                        <label class="statistics">
                            <?php echo $TEXT['navi-dutytime'] ?>
                        </label>
                        <label id="dutytime" class="statisticsval"></label><br>
                        <label id="sensorfuelconsumption_text" class="statistics">
                            <?php echo $TEXT['navi-sensor-fuel-consumption'] ?>
                        </label>
                        <label id="sensorfuelconsumption" class="statisticsval"></label><br>
                        <label id="estimatefuelconsumption_text" class="statistics">
                            <?php echo $TEXT['navi-estimate-fuel-consumption'] ?>
                        </label>
                        <label id="estimatefuelconsumption" class="statisticsval"></label><br>
                        <label id="canfuelconsumption_text" class="statistics">
                            <?php echo $TEXT['navi-can-fuel-consumption'] ?>
                        </label>
                        <label id="canfuelconsumption" class="statisticsval"></label><br>
                        <label id="speedingdist_text" class="statistics">
                            <?php echo $TEXT['report-speeding-distance'] ?>
                        </label>
                        <label id="speedingdist" class="statisticsval"></label><br>
                        <label class="statistics">
                            <?php echo $TEXT['report-speeding-last-time'] ?>:
                        </label>
                        <label id="speedingtime" class="statisticsval"></label><br>
                        <label class="statistics">
                            <?php echo $TEXT['report-speeding-count'] ?>:
                        </label>
                        <label id="speedingcount" class="statisticsval"></label><br>
                        <label class="statistics">
                            <?php echo $TEXT['report-engine-on-count'] ?>:
                        </label>
    ...
    <div id="mnuOperat" class="mnuOperat" style="display: none;">
        <ul>
            <li id="export_xls" style="border-top:3px solid #2982D6; width: 150px; cursor: pointer;"
                onClick="doExport(1);"><a
                    style="pointer-events: none; padding-left: 25px; background: transparent url('img/xls.svg') no-repeat 4px center; background-size: 18px 18px;"
                    href="#">
                    <?php echo $TEXT['button-export-xls'] ?>
                </a></li>
            <li id="export_pdf" style="width: 150px; cursor: wait;" onClick="exportPdf();"><a
                    style="pointer-events: none; padding-left: 25px; background: transparent url('img/pdf.svg') no-repeat 4px center; background-size: 18px 18px;"
                    href="#">
                    <?php echo $TEXT['button-export-pdf'] ?>
                </a></li>
            <li id="export_html" style="width: 150px; cursor: pointer;" onClick="doExport(3);"><a
                    style="pointer-events: none; padding-left: 25px; background: transparent url('img/html.svg') no-repeat 4px center; background-size: 18px 18px;"
                    href="#">
                    <?php echo $TEXT['button-export-html'] ?>
                </a></li>
            <li id="export_csv" style="width: 150px; cursor: pointer;" onClick="doExport(4);"><a
                    style="pointer-events: none; padding-left: 25px; background: transparent url('img/csv.svg') no-repeat 4px center; background-size: 18px 18px;"
                    href="#">
                    <?php echo $TEXT['button-export-csv'] ?>
                </a></li>
            <li id="export_doc" style="width: 150px; cursor: pointer;" onClick="doExport(5);"><a
                    style="pointer-events: none; padding-left: 25px; background: transparent url('img/doc.svg') no-repeat 4px center; background-size: 18px 18px;"
                    href="#">
                    <?php echo $TEXT['button-export-doc'] ?>
                </a></li>
            <li id="export_txt" style="width: 150px; cursor: pointer;" onClick="doExport(6);"><a
                    style="pointer-events: none; padding-left: 25px; background: transparent url('img/txt.svg') no-repeat 4px center; background-size: 18px 18px;"
                    href="#">
                    <?php echo $TEXT['button-export-txt'] ?>
                </a></li>
        </ul>
    </div>
    <!--map container-->
    ...
    <div id="tab_altitudechart" class="tab_content"></div>-->
        <div id="tab_movesdetail" style="overflow:auto;" class="tab_content">
            <table id="table_movesdetail" class="tab_report">
                <thead>
                    <tr>
                        <th width="4%">
                            <?php echo $TEXT['report-no'] ?>
                        </th>
                        <th width="13%">
                            <?php echo $TEXT['report-start'] ?>
                        </th>
                        <th width="25%">
                            <?php echo $TEXT['report-start-location'] ?>
                        </th>
                        <th width="13%">
                            <?php echo $TEXT['report-end'] ?>
                        </th>
                        <th width="25%">
                            <?php echo $TEXT['report-end-location'] ?>
                        </th>
                        <th width="10%">
                            <?php echo $TEXT['report-duration'] ?>
                        </th>
                        <th width="10%">
                            <?php echo $TEXT['navi-distance'] ?>
                        </th>
                        <th width="10%" style='display:none'>
                            <?php echo $TEXT['report-maxspeed'] ?>
                        </th>
                        <th width="10%" style='display:none'>
                            <?php echo $TEXT['report-divtime'] ?>
                        </th>
                        <th width="10%" style='display:none'>
                            <?php echo $TEXT['report-idletime'] ?>
                        </th>
                        <th width="10%" style='display:none'>
                            <?php echo $TEXT['navi-sensor-fuel-consumption'] ?>
                        </th>
        ...
        <div id="tab_messages" class="tab_content">
                ...
                <table id="table_messages" class="tab_report">
                    <thead>
                        <tr>
                            ...
                            <th width="8%">
                                <?php echo $TEXT['js-gpsvalid'] ?>
                            </th>
                            <th width="8%">
                                <?php echo $TEXT['info-latitude'] ?>
                            </th>
                            <th width="8%">
                                <?php echo $TEXT['info-longitude'] ?>
                            </th>
                            <th width="8%">
                                <?php echo $TEXT['navi-speed'] ?>
                            </th>
                            <th width="6%">
                                <?php echo $TEXT['info-heading'] ?>
                            </th>
                            <th width="10%">
                                <?php echo $TEXT['info-gpstime'] ?>
                            </th>
                            <th width="10%">
                                <?php echo $TEXT['info-revtime'] ?>
                            </th>
                        </tr>
                    </thead>
                </table>
            ...
            <div id="message_tool">
                ...
                <label>
                    <?php echo $TEXT['js-playback-msg-page'] ?>
                </label>
                <input id="page_current"></input>
                <label>
                    <?php echo $TEXT['js-playback-msg-of'] ?>
                </label>
    ...
    <div id="speedcompass" class="speedcompassshow" style="display: none;">
        <h3>
            <?php echo $TEXT['navi-speed_compass'] ?>
        </h3>
