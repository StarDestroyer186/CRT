...
class db {
    ...
    public function __construct($host, $dbms, $user, $pwd, $debug=true) {
        $this->is_debug = $debug;
    ...
    public function query($sql, $params = null) {
        ...
        return $this->do_query($sql, $params);
    }
    
    public function queryLastDS($sql, $params = null) {
        $this->last_sql = $sql;
        $this->write_log('query() called.');
        if (!$this->conn) {
            try {
        ...
        return $this->do_query_last_ds($sql, $params);
    }
