...
function(e) {
  ...
  var t = L.MarkerClusterGroup = L.FeatureGroup.extend({
    ...
    clearLayers: function() {
      return this._map || (this._needsClustering = [], this._needsRemoving = [], delete this._gridClusters, delete this._gridUnclustered),
    ...
    _removeFromGridUnclustered: function(e, t) {
      ...
      r = Math.floor(this._map.getMinZoom()); t >= r && n[t].removeObject(e, i.project(e.getLatLng(), t)); t--);
    },
    ...
    _bindEvents: function() {
      ...
      n = this.options.zoomToBoundsOnClick; (t || n) && this.on("clusterclick", this._zoomOrSpiderfy, this),
    ...
    _zoomOrSpiderfy: function(e) {
      for (var t = e.layer,
      i = t; 1 === i._childClusters.length;) i = i._childClusters[0];
    ...
    _unbindEvents: function() {
      ...
      n = this._map; (e || i) && this.off("clusterclick", this._zoomOrSpiderfy, this),
  ...
  L.MarkerClusterGroup.include({
    ...
    _withAnimation: {
      ...
      _animationZoomIn: function(e, t) {
        ...
        this._ignoreMove = !0,
        this._topClusterLevel._recursively(n, e, s,
        function(s) {
          var o, a = s._latlng,
          h = s._markers;
        ...
        this._topClusterLevel._recursively(n, e, t,
        function(e) {
  ...
  var i = L.MarkerCluster = L.Marker.extend({
    ...
    _recursivelyAnimateChildrenIn: function(e, t, i) {
      this._recursively(e, this._group._map.getMinZoom(), i - 1,
      function(e) {
    ...
    _recursivelyBecomeVisible: function(e, t) {
      this._recursively(e, this._group._map.getMinZoom(), t, null,
      function(e) {
        e.clusterShow()
      })
    },
    _recursivelyAddChildrenToMap: function(e, t, i) {
      this._recursively(i, this._group._map.getMinZoom() - 1, t,
      function(n) {
    ...
    L.QuickHull = {
      ...
      getConvexHull: function(e) {
        ...
        for (t = e.length - 1; t >= 0; t--) {
          var d = e[t]; (i === !1 || d.lat > i) && (o = d, i = d.lat),
  ...
  L.MarkerCluster.include({
    _animationSpiderfy: function(e, t) {
      ...
      u.addLayer(r),
      n._spiderLeg = r,
      p && (s = r._path, o = s.getTotalLength() + .1, s.style.strokeDasharray = o, s.style.strokeDashoffset = o),
      n.setZIndexOffset && n.setZIndexOffset(1e6),
    ...
    _animationUnspiderfy: function(e) {
      ...
      t._preSpiderfyLatlng && (t.closePopup(), t.setLatLng(t._preSpiderfyLatlng), delete t._preSpiderfyLatlng, o = !0, t._setPos && (t._setPos(_), o = !1), t.clusterHide && (t.clusterHide(), o = !1), o && u.removeLayer(t), c && (n = t._spiderLeg, r = n._path, s = r.getTotalLength() + .1, r.style.strokeDashoffset = s, n.setStyle({
        opacity: 0
      })));
      h._ignoreMove = !1,
      setTimeout(function() {
