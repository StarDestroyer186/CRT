(function() {
    ...
    L.Marker.include({
        ...
        _slideTo: function() {
			...
			/*var latLngs = [currLatLng];
			var markerBounds = L.latLngBounds(latLngs);
			this._slideWndMap.fitBounds(markerBounds,{maxZoom: this._slideWndMap.getZoom()});
			*/
				
			/*if(!this._map.getBounds().contains(currLatLng)){
		...
		setStart: function(wndMap){
			this._slideWndMap = wndMap;
		},
		onEnd: function(){
			this._slideEnd();
		},
