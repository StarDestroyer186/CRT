...
<body onload="oninit();" onunload="onfree();" onContextMenu="return true">
    ...
    <!--alarm info-->
  <div id="dlg_altinfo" class="dialog" style="width: 450px; position: fixed; top: 25rem; left: 65rem;">
    <div class="out">
        <div class="in">
            <h2 id="dlg_altinfo_title" style="padding: 5px;"><?php echo $TEXT['navi-alarminfo'] ?></h3>
            <div class="content" style="height: 500px;">
                <ul id="altul">                        
                </ul>
            </div>
            <div class="footer">
                <input id="button_ok" type="button" class="button small" style="height: 24px;" value="<?php echo $TEXT['button-ok'] ?>"/>
            </div>
        </div>
    </div>
</div>
