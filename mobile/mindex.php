...
<body onload="oninit();" onContextMenu="return true;">
		...
		<div id="object_detail" class="details-panel" style="display: none; bottom: 0px;">
			<div id="object_detail_scmd_list" class="panel panel-default">
				<table id="object_detail_scmd" class="general" border="0" cellpadding="0" cellspacing="0">
					...
					<tbody>
						<tr>
							<td><?php echo $TEXT['info-cmd-enable-immobilizer'] ?></td>
							<td><input type='checkbox' id='scmd_cut' class='cmdcheckbox'></input><label class='cmdswitch' for='scmd_cut'></label></td>
						</tr>
						<tr>
							<td><?php echo $TEXT['info-cmd-disable-immobilizer'] ?></td>
							<td><input type='checkbox' id='scmd_uncut' class='cmdcheckbox'></input><label class='cmdswitch' for='scmd_uncut'></label></td>
						</tr>
						<tr>
							<td><?php echo $TEXT['info-cmd-arm'] ?></td>
							<td><input type='checkbox' id='scmd_arm' class='cmdcheckbox'></input><label class='cmdswitch' for='scmd_arm'></label></td>
						</tr>
						<tr>
							<td><?php echo $TEXT['info-cmd-disarm'] ?></td>
							<td><input type='checkbox' id='scmd_disarm' class='cmdcheckbox'></input><label class='cmdswitch' for='scmd_disarm'></label></td>
						</tr>
						<tr>
							<td><?php echo $TEXT['info-cmd-lock-door'] ?></td>
							<td><input type='checkbox' id='scmd_lock' class='cmdcheckbox'></input><label class='cmdswitch' for='scmd_lock'></label></td>
						</tr>
						<tr>
							<td><?php echo $TEXT['info-cmd-unlock-door'] ?></td>
							<td><input type='checkbox' id='scmd_unlock' class='cmdcheckbox'></input><label class='cmdswitch' for='scmd_unlock'></label></td>
						</tr>
					</tbody>
				</table>
			</div>
				...
				<table id="last5day_table" class="general" border="0" cellpadding="0" cellspacing="0">
					...
					<tbody>
						<tr style="border='none';">
							<td style="border-top: 1px solid #DDDDDD; align='top'; width: 50%;">
								<div id="last5day_mil" style="min-height: 100px;"></div>
							</td>
						</tr>
						<tr style="border='none';">
							<td style="border-top: 1px solid #DDDDDD; align='top'; width: 50%;">
								<div id="last5day_eng" style="min-height: 100px;"></div>
							</td>
						</tr>
						<tr style="border='none';">
							<td style="border-top: 1px solid #DDDDDD; align='top'; width: 50%;">
								<div id="last5day_load" style="min-height: 100px;"></div>
							</td>
						</tr>
						<tr style="border='none';">
							<td style="border-top: 1px solid #DDDDDD; align='top'; width: 50%;">
								<div id="last5day_tire" style="min-height: 100px;"></div>
							</td>
						</tr>
					</tbody>
				</table>
	...
	<div id="page_dashboard" class="page_dashboard" style="display: none;">
		...
		<div id="dashboard">
			<div id="dashboard-table-div">
				<table id="dashboard-table" border="0" cellpadding="0" cellspacing="0">
					<tr style="border='none';">
						<td style="border-top: 1px solid #DDDDDD; align='top'; width: 50%;">
							<div id="sta_on_off_exp" style="min-height: 180px;"></div>
						</td>
						<td style="border-top: 1px solid #DDDDDD; align='top'; width: 50%;">
							<div id="sta_mov_sti_alm" style="min-height: 180px;"></div>
						</td>
					</tr>
					<tr style="border='none';">
						<td style="border-bottom: 1px solid #DDDDDD; align='top'; width: 50%;">
							<div id="sta_speed_range" style="min-height: 180px;"></div>
						</td>
						<td style="border-bottom: 1px solid #DDDDDD; align='top'; width: 50%;">
							<div id="sta_exp_time" style="min-height: 180px;"></div>
						</td>
					</tr>
					<tr style="border='none';">
						<td colspan="2" style="border-bottom: 1px solid #DDDDDD; align='top'; width: 100%;">
							<div id="sta_last24h_moving" style=" min-height: 240px;"></div>
						</td>
					</tr>
					<tr style="border='none';">
						<td colspan="2" style="border-bottom: 1px solid #DDDDDD; align='top'; width: 100%;">
							<div id="sta_last24h_idle" style="min-height: 240px;"></div>
						</td>
					</tr>
					<tr style="border='none';">
						<td colspan="2" style="border-bottom: 1px solid #DDDDDD; align='top'; width: 100%;">
							<div id="sta_last24h_mileage" style="min-height: 240px;"></div>
						</td>
					</tr>
					<tr style="border='none';">
						<td colspan="2" style="border-bottom: 1px solid #DDDDDD; align='top'; width: 100%;">
							<div id="sta_last24h_engine" style="min-height: 240px;"></div>
						</td>
					</tr>
				</table>
			</div>
	...
	<div id="page_events" class="page_events" style="display: none;">
		<div class="title-block" ontouchmove="event.preventDefault();">
			<a href="#" onclick="showPage('page_menu');">
				<i></i>
			</a>
	...
	<div id="dlg_lastphoto" class="dialog" style="width: 330px;">
		<div class="out">
			<div class="in">
				<h3 onmousedown="dragstart('dlg_lastphoto', event)" onmousemove="dragmove(event)"><?php echo $TEXT['navi-lastphoto'] ?></h3>
				<p id="phototime"></p>
	...
	<div id="dlg_lastvoice" class="dialog" style="width: 330px;">
		<div class="out">
			<div class="in">
				<h3 onmousedown="dragstart('dlg_lastvoice', event)" onmousemove="dragmove(event)"><?php echo $TEXT['js-lastvoice'] ?></h3>
				<p id="voicetime"></p>
